...
def approval(asset_a: TealType.uint64, asset_b: TealType.uint64):
    ...
    def deposit():
        ...
        return Seq(
            ...
            ratio.store(If(ratio_state.hasValue(), ratio_state.value(), update_ratio())),
    ...
    def create_pool_token():
        return Seq(
            ...
            InnerTxnBuilder.SetFields({
                ...
                TxnField.config_asset_name: Bytes("DemoPoolToken"), #TODO: add specific asset references in name?
...
if __name__ == "__main__":
    ...
    with open(os.path.join(path, "approval.teal"), "w") as f:
        f.write(compileTeal(approval(Int(10), Int(100)), mode=Mode.Application, version=5))
